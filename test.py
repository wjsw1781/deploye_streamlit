...
#         'https://':'socks5://'+ proxy,
# }
res=get_request('https://ipinfo.io/json',proxies=proxies)
print(res.text)
...
git remote add origin https://gitee.com/wang_zhi_quan/deploy_streamlit.git
...
pip install awscli-plugin-endpoint -i https://pypi.tuna.tsinghua.edu.cn/simple --proxy=http://10.1.11.
100:8086 
